...
namespace MinhDucEvent.BackendApi
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<MinhDucEventDbContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString(SystemConstants.MainConnectionString)));

            services.AddIdentity<AppUser, AppRole>()
                .AddEntityFrameworkStores<MinhDucEventDbContext>()
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Swagger MinhDucEvent", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Swagger MinhDucEvent V1");
            });
